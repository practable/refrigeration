                ...
                <div class="modal-dialog">
                    <div class="modal-content" >
                        <div class="modal-header">
                            ...
                            <button type='button' :class="getDarkTheme ? 'btn-close' : 'btn-close btn-close-white'"
                                id='close-button' @click='toggleHelp'></button>
                        </div>
                        <div class="modal-body" style="max-height: 500px; overflow: auto;">
                            <slot id='popup-text'></slot>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" @click="toggleHelp"
                                id="help_close">Close</button>
                        </div>
                    </div>
