...
#define FIRMWARE_VERSION "refrigerationFirmware_V1.5.0"
...
#define FAN_SPEED_CONTROL true   // enables/disables the fan speed controller (no fan speed control possible in frig00)
